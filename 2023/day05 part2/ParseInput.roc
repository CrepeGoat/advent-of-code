interface ParseInput
    exposes [parse, Almanac, SuppliesMap, SeedsRange]
    imports [
        parse.Core.{
            Parser,
            const,
...
Almanac : { seedsRanges : List SeedsRange, maps : List SuppliesMap }
SuppliesMap : {
    givenSupply : Str,
    requiredSupply : Str,
